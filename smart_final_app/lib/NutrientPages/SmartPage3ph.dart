...
class SmartPage3ph extends StatefulWidget {
  SmartPage3ph({super.key});

  @override
  State<StatefulWidget> createState() => _SmartPage3ph();
}

class _SmartPage3ph extends State<SmartPage3ph> {
  @override
...
String statusMessage = phStatusMessages[ getStatusIndexForN(dataArray['ph']!)];
                      ...
                      child: Stack(
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                getStatusForN(dataArray['ph']!), // Using the getStatusForN function from DataPage.dart
                                textAlign: TextAlign.center,
                                style: TextStyle(
