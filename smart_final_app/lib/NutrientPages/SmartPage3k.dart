...
class SmartPage3k extends StatefulWidget {
  SmartPage3k({super.key});

  @override
  State<StatefulWidget> createState() => _SmartPage3k();
}

class _SmartPage3k extends State<SmartPage3k> {
  @override
...
String statusMessage = kStatusMessages[ getStatusIndexForN(dataArray['k']!)];
                      ...
                      child: Stack(
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                getStatusForN(dataArray['k']!), // Using the getStatusForN function from DataPage.dart
                                textAlign: TextAlign.center,
                                style: TextStyle(
