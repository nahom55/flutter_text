...
class SmartPage3h extends StatefulWidget {
  SmartPage3h({super.key});

  @override
  State<StatefulWidget> createState() => _SmartPage3h();
}

class _SmartPage3h extends State<SmartPage3h> {
  @override
...
String statusMessage = hStatusMessages[ getStatusIndexForN(dataArray['h']!)];
                      ...
                      child: Stack(
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                getStatusForN(dataArray['h']!), // Using the getStatusForN function from DataPage.dart
                                textAlign: TextAlign.center,
                                style: TextStyle(
