...
class SmartPage3p extends StatefulWidget {
  SmartPage3p({super.key});

  @override
  State<StatefulWidget> createState() => _SmartPage3p();
}

class _SmartPage3p extends State<SmartPage3p> {
  @override
...
String statusMessage = pStatusMessages[ getStatusIndexForN(dataArray['p']!)];
                      ...
                      child: Stack(
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                getStatusForN(dataArray['p']!), // Using the getStatusForN function from DataPage.dart
                                textAlign: TextAlign.center,
                                style: TextStyle(
