...
class SmartPage2 extends StatefulWidget {
  SmartPage2({super.key});

  @override
  State<StatefulWidget> createState() => _SmartPage2();
}

class _SmartPage2 extends State<SmartPage2> {
  @override
  ...
  child: SfRadialGauge(
    ...
    axes: <RadialAxis>[
      RadialAxis(
        ...
        pointers: <GaugePointer>[
          NeedlePointer(
            value: dataArray['ph']!.toDouble(), // Using 4th index data as default
            enableAnimation: true,
            needleLength: 0.7, // Adjust length if needed
            needleStartWidth: 0.5, // Set a thinner start width
            needleEndWidth: 2,
  ...
  GaugeRange(startValue: 100, endValue: 150, color: Colors.red, ), // Decrease the thickness as needed
        ...
        annotations: <GaugeAnnotation>[
          GaugeAnnotation(
            widget: Text(
              dataArray['ph'].toString(), // Displaying 4th index data
              style: TextStyle(
                fontSize: 15.0,
                fontWeight: FontWeight.bold,
              ),
  ...
  child: SfRadialGauge(
    ...
    axes: <RadialAxis>[
      RadialAxis(
        ...
        pointers: <GaugePointer>[
          NeedlePointer(
            value: dataArray['k']!.toDouble(), // Using 4th index data as default
            enableAnimation: true,
            needleLength: 0.7, // Adjust length if needed
            needleStartWidth: 0.5, // Set a thinner start width
            needleEndWidth: 2,
  ...
  GaugeRange(startValue: 100, endValue: 150, color: Colors.red, ), // Decrease the thickness as needed
        ...
        annotations: <GaugeAnnotation>[
          GaugeAnnotation(
            widget: Text(
              dataArray['k'].toString(), // Displaying 4th index data
              style: TextStyle(
                fontSize: 15.0,
                fontWeight: FontWeight.bold,
              ),
  ...
  child: SfRadialGauge(
    ...
    axes: <RadialAxis>[
      RadialAxis(
        ...
        pointers: <GaugePointer>[
          NeedlePointer(
            value: dataArray['p']!.toDouble(), // Using 4th index data as default
            enableAnimation: true,
            needleLength: 0.7, // Adjust length if needed
            needleStartWidth: 0.5, // Set a thinner start width
            needleEndWidth: 2,
  ...
  GaugeRange(startValue: 100, endValue: 150, color: Colors.red, ), // Decrease the thickness as needed
        ...
        annotations: <GaugeAnnotation>[
          GaugeAnnotation(
            widget: Text(
              dataArray['p'].toString(), // Displaying 4th index data
              style: TextStyle(
                fontSize: 15.0,
                fontWeight: FontWeight.bold,
              ),
  ...
  child: SfRadialGauge(
    ...
    axes: <RadialAxis>[
      RadialAxis(
        ...
        pointers: <GaugePointer>[
          NeedlePointer(
            value: dataArray['h']!.toDouble(), // Using 4th index data as default
            enableAnimation: true,
            needleLength: 0.7, // Adjust length if needed
            needleStartWidth: 0.5, // Set a thinner start width
            needleEndWidth: 2,
  ...
  GaugeRange(startValue: 100, endValue: 150, color: Colors.red, ), // Decrease the thickness as needed
        ...
        annotations: <GaugeAnnotation>[
          GaugeAnnotation(
            widget: Text(
              dataArray['h'].toString(), // Displaying 4th index data
              style: TextStyle(
                fontSize: 15.0,
                fontWeight: FontWeight.bold,
              ),
